...
func TestDomainSetLang(t *testing.T) {
	...
	Convey("English domain requested - with query params", t, func() {
		So(helper.DomainSetLang("www.ons.gov.uk", "/foo/bar/baz", "q=searchterm", "en"), ShouldEqual, "https://www.ons.gov.uk/foo/bar/baz?q=searchterm")
		So(helper.DomainSetLang("ons.gov.uk", "", "q=searchterm", "en"), ShouldEqual, "https://www.ons.gov.uk?q=searchterm")
		So(helper.DomainSetLang("https://www.ons.gov.uk", "/foo/bar/baz", "q=searchterm", "en"), ShouldEqual, "https://www.ons.gov.uk/foo/bar/baz?q=searchterm")
		So(helper.DomainSetLang("https://ons.gov.uk", "", "q=searchterm", "en"), ShouldEqual, "https://www.ons.gov.uk?q=searchterm")
		So(helper.DomainSetLang("www.cy.ons.gov.uk", "/foo/bar/baz", "q=searchterm", "en"), ShouldEqual, "https://www.ons.gov.uk/foo/bar/baz?q=searchterm")
		So(helper.DomainSetLang("cy.ons.gov.uk", "", "q=searchterm", "en"), ShouldEqual, "https://www.ons.gov.uk?q=searchterm")
		So(helper.DomainSetLang("https://www.cy.ons.gov.uk", "/foo/bar/baz", "q=searchterm", "en"), ShouldEqual, "https://www.ons.gov.uk/foo/bar/baz?q=searchterm")
		So(helper.DomainSetLang("https://cy.ons.gov.uk", "", "q=searchterm", "en"), ShouldEqual, "https://www.ons.gov.uk?q=searchterm")
		So(helper.DomainSetLang("www.foo-bar.baz.co.uk", "/foo/bar/baz", "q=searchterm", "en"), ShouldEqual, "https://www.foo-bar.baz.co.uk/foo/bar/baz?q=searchterm")
		So(helper.DomainSetLang("cy.foo-bar.baz.co.uk", "", "q=searchterm", "en"), ShouldEqual, "https://www.foo-bar.baz.co.uk?q=searchterm")
		So(helper.DomainSetLang("https://www.cy.foo-bar.baz.co.uk", "/foo/bar/baz", "q=searchterm", "en"), ShouldEqual, "https://www.foo-bar.baz.co.uk/foo/bar/baz?q=searchterm")
		So(helper.DomainSetLang("https://cy.foo-bar.baz.co.uk", "", "q=searchterm", "en"), ShouldEqual, "https://www.foo-bar.baz.co.uk?q=searchterm")
		So(helper.DomainSetLang("https://cy.foo-bar.baz.co.uk", "https://foo:12345/bar/baz/qux", "q=searchterm", "en"), ShouldEqual, "https://www.foo-bar.baz.co.uk/bar/baz/qux?q=searchterm")
	})

	Convey("Welsh domain requested - with query params", t, func() {
		So(helper.DomainSetLang("www.ons.gov.uk", "", "q=searchterm", "cy"), ShouldEqual, "https://cy.ons.gov.uk?q=searchterm")
		So(helper.DomainSetLang("ons.gov.uk", "/foo/bar/baz", "q=searchterm", "cy"), ShouldEqual, "https://cy.ons.gov.uk/foo/bar/baz?q=searchterm")
		So(helper.DomainSetLang("https://www.ons.gov.uk", "", "q=searchterm", "cy"), ShouldEqual, "https://cy.ons.gov.uk?q=searchterm")
		So(helper.DomainSetLang("https://ons.gov.uk", "/foo/bar/baz", "q=searchterm", "cy"), ShouldEqual, "https://cy.ons.gov.uk/foo/bar/baz?q=searchterm")
		So(helper.DomainSetLang("www.cy.ons.gov.uk", "", "q=searchterm", "cy"), ShouldEqual, "https://cy.ons.gov.uk?q=searchterm")
		So(helper.DomainSetLang("cy.ons.gov.uk", "/foo/bar/baz", "q=searchterm", "cy"), ShouldEqual, "https://cy.ons.gov.uk/foo/bar/baz?q=searchterm")
		So(helper.DomainSetLang("https://www.cy.ons.gov.uk", "", "q=searchterm", "cy"), ShouldEqual, "https://cy.ons.gov.uk?q=searchterm")
		So(helper.DomainSetLang("https://cy.ons.gov.uk", "/foo/bar/baz", "q=searchterm", "cy"), ShouldEqual, "https://cy.ons.gov.uk/foo/bar/baz?q=searchterm")
		So(helper.DomainSetLang("www.foo-bar.baz.co.uk", "", "q=searchterm", "cy"), ShouldEqual, "https://cy.foo-bar.baz.co.uk?q=searchterm")
		So(helper.DomainSetLang("cy.foo-bar.baz.co.uk", "/foo/bar/baz", "q=searchterm", "cy"), ShouldEqual, "https://cy.foo-bar.baz.co.uk/foo/bar/baz?q=searchterm")
		So(helper.DomainSetLang("https://www.cy.foo-bar.baz.co.uk", "", "q=searchterm", "cy"), ShouldEqual, "https://cy.foo-bar.baz.co.uk?q=searchterm")
		So(helper.DomainSetLang("https://cy.foo-bar.baz.co.uk", "/foo/bar/baz", "q=searchterm", "cy"), ShouldEqual, "https://cy.foo-bar.baz.co.uk/foo/bar/baz?q=searchterm")
		So(helper.DomainSetLang("https://cy.foo-bar.baz.co.uk", "https://foo:12345/bar/baz/qux", "q=searchterm", "cy"), ShouldEqual, "https://cy.foo-bar.baz.co.uk/bar/baz/qux?q=searchterm")
	})
